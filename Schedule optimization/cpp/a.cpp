...
void printFlowerAndGreeting() {
    ...
    printWithDelay(" ***       '      `\\/ '     *  '      `\\/ '     *\n", 30);
    printWithDelay("  V       (                .*)(               . *)\n", 30);
    printWithDelay("/\\|/\\      \\     \033[1;35mQuang\033[1;31m  . *./  \\       \033[1;35mTâm\033[1;31m   . *./ \n", 30);
    printWithDelay("  |         `\\ .      . .*/'    `\\ .      . .*/'       .*.\n", 30);
    printWithDelay("  |           `\\ * .*. */' _    _ `\\ * .*. */'         ***\n", 30);
    printWithDelay("                `\\ * */'  ( `\\/'*)   `\\ * */'         /\\V\n", 30);
    printWithDelay("                  `\\/ '    \\   */'     `\\/ '            |/\\\n", 30);
    ...
    printWithDelay("  Chuc \033[1;35mBe iu\033[1;37m ngay 20-10 that vui ve, iu be nhiuuuu \033[1;35m\u2764 \u2764 \u2764 \n", 50);
